...
import com.example.master.repository.UserHierarcyRepository;
...
public class UserHierarcyDao {
    ...
    public List<UserHierarchy> getHierarchyByHrId(long id, long orgHead){
    	return hierarcyRepository.findByHrId(id,orgHead);
    }
    ...
    public List<UserHierarchy> getHierarchyByOrgHeadsAndGroupHead(long orgHead, long grpHead){
    	return hierarcyRepository.findByOrgHeadAndGropHead(orgHead, grpHead);
    }
    ...
    public List<UserHierarchy> getHierarchyByOrgHeadsAndHrManagerAndPriSuper(long orgHead, 
																	    		long hrManager, 
																	    		long priSupervisor){
    	return hierarcyRepository.findByHrAndOrgHeadAndPriSuper(orgHead, 
													    			hrManager, 
													    			priSupervisor);
    }
    
    public List<UserHierarchy> getHierarchyByOrgHeadsAndHrManagerAndPriSuperAndPrjSuper(long orgHead, 
																				    		long hrManager,
																				    		long priSupervisor,
																				    		long prjSuper){
    	return hierarcyRepository.findByHrAndOrgHeadAndPriSuperAndPrjSuper(orgHead,
															    			hrManager, 
															    			priSupervisor,
															    			prjSuper);
    }
    
    public List<UserHierarchy> getHierarchyByOrgHeadsAndHrManagerAndPriSuperAndPrjSuperAndUser(
								    															long orgHead, 
								    															long hrManager, 
								    															long priSupervisor, 
								    															long prjSuper, 
    	...
    	return hierarcyRepository.findByHrAndOrgHeadAndPriSuperAndPrjSuperAndUser(orgHead,
																	    			hrManager,
																	    			priSupervisor,
																	    			prjSuper,
																	    			user);
